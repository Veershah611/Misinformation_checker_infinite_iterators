...
// import { Loader2, Upload, CheckCircle, XCircle, AlertTriangle, HelpCircle, Search, Link as LinkIcon, FileText, ThumbsUp, ThumbsDown, ShieldAlert, BookUser, Link2 } from "lucide-react"
...
//         public_guidance_and_resources: {
//           tips_to_identify_similar_scams: [],
//           official_government_resources: { relevant_agency_website: "", national_helpline_number: "" },
//         },
//         evidence_log: { external_sources: [] },
//       })
//     } finally {
//       setIsLoading(false)
//     }
...
//                 <h1 className="text-4xl font-bold mb-2 text-balance">Misinformation Checker</h1>
//               </div>
//               <div className="flex-1 flex justify-end">
//                 <ThemeToggle />
//               </div>
//             </div>
//             <div className="text-lg text-muted-foreground text-pretty">
//               <ShinyText
//                 text="Verify information through claims, URLs, or files using AI-powered analysis and real-time web search."
//                 disabled={false}
//                 speed={3}
...
//                                 Verdict: {results.claim_analysis.verdict || "N/A"}
...
//                         {results.categorized_points && (results.categorized_points.points_supporting_truthfulness?.length > 0 || results.categorized_points.points_refuting_the_claim?.length > 0) && (
...
//                         {results.public_guidance_and_resources && (
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <header className="text-center mb-8 animate-in fade-in-0 slide-in-from-bottom-4 duration-700">
              ...
              <div className="flex-1   text-center">
                <BlurText
                  ...
                  onAnimationComplete={handleAnimationComplete}
                   className="text-3xl sm:text-3xl lg:text-4xl font-extrabold tracking-wider text-foreground"
                />
              </div>
              <div className="flex-1 flex justify-end">
            ...
            <p className="text-lg text-muted-foreground text-pretty">
              <TextType
                text={["Verify claims, URLs, or files using AI-powered analysis and real-time web search"]}
                typingSpeed={75}
                pauseDuration={1500}
                showCursor={true}
                cursorCharacter="."
                className="mt-4 text-lg text-muted-foreground tracking-wide"
              />
